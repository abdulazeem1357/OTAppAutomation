...
public class AndroidBasics extends BasePage {
    ...
    public void turnOffInternetConnectivity() {
        connection = driver.getConnection();
    ...
    public void turnOnInternetConnectivity() {
        connection = driver.getConnection();
        boolean changesMade = false;
    ...
    public void moveAppToBackgroundForFiveSeconds() {
        try {
    ...
    public void checkAppForegroundStatus() {
